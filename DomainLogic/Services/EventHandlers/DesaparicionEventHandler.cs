...
namespace DomainLogic.Services.EventHandlers
{
    ...
    {        
        ...
        public async Task Handle(DesaparicionEvent notification, CancellationToken cancellationToken)
        {
            ...
            var nuevaDesignacionProyectada = Designacion.Crear(nombreOriginal.Texto, 
                nombreOriginal.Causa.Texto,
                nombreOriginal.Naturaleza.Texto,
            ...
            var nuevaDesignacionAux = Designacion.Crear(nombreOriginal.Texto, nombreOriginal.Causa.Texto, nombreOriginal.Naturaleza.Texto, nombreOriginal.Causa.Frecuencia + _random.Next(2), nombreOriginal.Naturaleza.Fase);
            var resultado = nuevoNombre.Mostrarse(nuevaDesignacionAux);
